        ...
        return `
            <div class="track-card">
                <div style="display: flex; align-items: center; gap: 8px; justify-content: flex-end; margin-bottom: 12px; min-height: 28px;">
                    ...
                    ` : ''}
                    ${track.spotify_id ? `
                        <a href="https://open.spotify.com/track/${track.spotify_id}" target="_blank" style="display: inline-flex; align-items: center; gap: 4px; padding: 6px 12px; background-color: #1ED760; color: #000; font-weight: 600; border-radius: 6px; text-decoration: none; font-size: 13px; transition: background-color 0.2s;">
                    ...
                    ` : ''}
                    ${isAuthenticated ? `
                        <a href="admin/edit.html?id=${track.id}" style="display: inline-flex; align-items: center; gap: 4px; padding: 6px 12px; background-color: #6366f1; color: white; font-weight: 500; border-radius: 6px; text-decoration: none; font-size: 13px; transition: background-color 0.2s;">
